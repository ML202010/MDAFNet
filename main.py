...
def parse_args():
    ...
    parser.add_argument('--weight-path', type=str, default='/MDAFNet/MDAFNet-main/weight/irstd1k_weight.pkl')
    ...
    def __init__(self, args):
        ...
        if args.mode == 'train':
            if args.if_checkpoint:
                ...
                self.save_folder = '/MDAFNet/weight/MDAFNet-%s' % (
