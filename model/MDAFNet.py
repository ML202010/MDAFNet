...
class MDAFNet(nn.Module):
    def __init__(self, input_channels, block=ResNet):
        ...
        self.hwfe0 = HWFE(param_channels[0], residual_weight=0.9)  
        self.hwfe1 = HWFE(param_channels[1], residual_weight=0.85) 
        self.hwfe2 = HWFE(param_channels[2], residual_weight=0.7)  
        self.hwfe3 = HWFE(param_channels[3], residual_weight=0.6)
    ...
    def forward(self, x, warm_flag):
        ...
        x_e2 = self.hwfe2(x_e2) 
        x_e3 = self.hwfe3(x_e3)  
